            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                        ...
                        <div class="box-body row">
                            ...
                            <div class="col-sm-4 col-md-4">
                                <div class="form-group">
                                    <label><?php echo $this->lang->line('enquiry'); ?>
                                        <?php echo $this->lang->line('date'); ?></label>
                                    <div class="input-group">
                                        <div class="input-group-addon">
                                            <i class="fa fa-calendar"></i>
                                        </div>
                                        <input type="text" autocomplete="off" name="enquiry_date"
                                            class="form-control pull-right date" id="enquiry_date">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="source" name="source" class="form-control">
                                        ...
                                        <option <?php
                                            ...
                                            ?> value="<?php echo $value["source"] ?>"><?php echo $value["source"] ?>
                                        </option>
                                        <?php } ?>
                                    </select>
                    ...
                    <div class="ptt10">
                        ...
                        <div class="bordertop">
                            <div class="box-header with-border">
                                <h3 class="box-title titlefix"> <?php echo $this->lang->line('admission_enquiry'); ?>
                                </h3>
                            ...
                            <div class="box-body">
                                <div class="download_label"><?php echo $this->lang->line('admission_enquiry'); ?>
                                        ...
                                        <table class="table table-hover table-striped table-bordered" id="enquirytable">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th><?php echo $this->lang->line('enquiry'); ?>
                                            ...
                                            <tbody>
                                                ...
                                                <tr <?php echo $class ?>>
                                                    ...
                                                    <td class="mailbox-date text-right">
                                                        ...
                                                        <a onclick="getRecord('<?php echo $value['id']; ?>', '<?php echo $value['status']; ?>')"
                                                        ...
                                                        <a data-placement="left" href="#" class="btn btn-default btn-xs"
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <form id="formadd" method="post" class="ptt10">
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label for="name_add"><?php echo $this->lang->line('name'); ?></label><small
                                                class="req"> *</small>
                                            <input type="text" id="name_add" autocomplete="off" class="form-control"
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label for="number"><?php echo $this->lang->line('phone'); ?></label><small
                                                class="req"> *</small>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label
                                                for="pwd"><?php echo $this->lang->line('next_follow_up_date'); ?></label>
                                            <input type="text" id="date_of_call" name="follow_up_date"
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="<?php echo set_value('assigned'); ?>"
                                                name="assigned" class="form-control">
                                        </div>
                                        <!--./form-group-->
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="reference" class="form-control">
                                                ...
                                                <option value="<?php echo $value['reference']; ?>"
                                                    <?php if (set_value('reference') == $value['reference']) { ?>selected=""
                                                    <?php } ?>><?php echo $value['reference']; ?></option>
                                                <?php }
                                                ?>
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            <label for="pwd"><?php echo $this->lang->line('source'); ?></label> <small
                                                class="req"> *</small>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="class" class="form-control">
                                                ...
                                                <option value="<?php echo $value['id'] ?>"
                                                    <?php if (set_value('class') == $value['id']) { ?> selected=""
                                                    <?php } ?>><?php echo $value['class'] ?></option>
                                                <?php
                                                }
                                                ?>
                                            </select>
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" min="1"
                                                value="<?php echo set_value('no_of_child'); ?>" name="no_of_child">
                                        </div>
                                        <!--./form-group-->
                                    </div>
                                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    numberInputs.forEach(input => {
        // Change type to 'tel' to remove the spinner
        input.setAttribute('type', 'tel');
        
        // Add event listener to restrict input to 10 digits and ensure only numbers are allowed
        ...
        // Prevent paste and restrict to 10 digits
        input.addEventListener('paste', function(e) {
            let pasteData = e.clipboardData.getData('text');
            pasteData = pasteData.replace(/[^0-9]/g, ''); // Remove non-numeric characters from pasted data
            if (pasteData.length > 10) {
                pasteData = pasteData.slice(0, 10); // Limit to 10 digits
            }
            e.preventDefault(); // Prevent the default paste behavior
            this.value = pasteData; // Set the cleaned value
        });

        // Prevent entering more than 10 digits by directly limiting input length
...
$(document).ready(function() {
    ...
    $('#enquiry_date').on('apply.daterangepicker', function(ev, picker) {
        $(this).val(picker.startDate.format(calendar_date_time_format) + ' - ' + picker.endDate.format(
